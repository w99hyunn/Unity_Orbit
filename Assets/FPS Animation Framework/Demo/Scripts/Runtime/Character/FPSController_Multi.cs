...
namespace Demo.Scripts.Runtime.Character
{
    ...
    public enum FPSActionState_Multi
    {
        None,
        PlayingAnimation,
        WeaponChange,
    ...
    public class FPSController_Multi : NetworkBehaviour
    {
        ...
        private FPSAimState_Multi _aimState;
        private FPSActionState_Multi _actionState;
        ...
        public event Action<FPSAimState_Multi> OnActiveAiming;
        ...
        {
            return _movementComponent.MovementState == FPSMovementState_Multi.Sprinting;
        }

        private bool HasActiveAction()
        {
            return _actionState != FPSActionState_Multi.None;
        }
        ...
        {
            _movementComponent = GetComponent<FPSMovement_Multi>();
        ...
        {
            DisableAim();
            _actionState = FPSActionState_Multi.WeaponChange;
        ...
        {
            if (GetActiveItem().OnAimReleased()) _aimState = FPSAimState_Multi.None;
        }
        ...
        private void OnSprintStarted()
        {
            ...
            _aimState = FPSAimState_Multi.None;
        ...
        {
            if (_movementComponent.PoseState == FPSPoseState_Multi.Prone)
            {
        ...
        {
            if (_movementComponent.PoseState == FPSPoseState_Multi.Prone) return;
        ...
        {
            if (HasActiveAction() && _actionState != FPSActionState_Multi.AttachmentEditing) return;

            _actionState = _actionState == FPSActionState_Multi.AttachmentEditing
                ? FPSActionState_Multi.None : FPSActionState_Multi.AttachmentEditing;

            if (_actionState == FPSActionState_Multi.AttachmentEditing)
            {
        ...
        {
            if (!value.isPressed || _actionState != FPSActionState_Multi.AttachmentEditing) return;
