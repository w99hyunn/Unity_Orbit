Shader "Hygn/Glitch"
{
    ...
    {   
        ...
        _StencilReadMask ("Stencil Read Mask", Float) = 255 // Default: all bits
        _StencilWriteMask ("Stencil Write Mask", Float) = 255 // Default: all bits
        _ColorMask ("Color Mask", Float) = 15 // Default: all channels (RGBA)
