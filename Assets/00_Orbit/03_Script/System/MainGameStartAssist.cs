...
namespace STARTING
{
    ...
    public class MainGameStartAssist : MonoBehaviour
    {
        ...
        private void LoadGameData(string path)
        {
            ...
            if (data != null)
            {
                ...
                if (data.level >= 3)
                {
                    multiPlayUnlock.SetActive(true);
                    multiPlayLock.SetActive(false);
                }
                else
                {
                    multiPlayUnlock.SetActive(false);
                    multiPlayLock.SetActive(true);
                }
            }
        }
