...
namespace Demo.Scripts.Runtime.Item
{
    ...
    public class Weapon_Multi : FPSItem
    {
        [Header("General")]
        ...
        [SerializeField] private OverlayType_Multi overlayType;
        ...
        public override void OnEquip(GameObject parent)
        {
            ...
            _fpsController = parent.GetComponent<FPSController_Multi>();
        ...
        IEnumerator ReloadSoundWithDelay()
        {
            ...
            GameManager_Multi.Instance.PlaySound(gunFire.clipOutSound);
            yield return new WaitForSeconds(reloadClip.clip.length * 0.2f);
            GameManager_Multi.Instance.PlaySound(gunFire.clipInSound);
            yield return new WaitForSeconds(reloadClip.clip.length * 0.3f);
            GameManager_Multi.Instance.PlaySound(gunFire.clipArmingSound);
        ...
        private void OnFire()
        {
            ...
            {
                GameManager_Multi.Instance.PlaySound(gunFire.dryFireSound);
                OnFireReleased();
                return;
            }
