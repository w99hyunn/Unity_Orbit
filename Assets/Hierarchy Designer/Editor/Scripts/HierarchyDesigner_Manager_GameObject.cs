...
namespace Verpha.HierarchyDesigner
{
    public static class HierarchyDesigner_Manager_GameObject
    {
        ...
        private const int dockedPropertiesBaseOffset = 15;
        ...
        private static readonly Texture2D prefabIcon = EditorGUIUtility.IconContent("Prefab Icon").image as Texture2D;
        ...
        private static void OnHierarchyChanged()
        {
            #region Header
            if (HierarchyDesigner_Manager_Editor.IsPlaying && disableEditorDesignerMajorOperationsDuringPlayMode) { return; }
            if (EditorWindow.focusedWindow != null && EditorWindow.focusedWindow.titleContent.text != hierarchyWindow) { return; }
            #endregion
        ...
        internal static Texture2D GetOrCreateBranchIcon(Transform transform)
        {
            ...
            {
                icon = transform.childCount > 0 ? HierarchyDesigner_Shared_Resources.TreeBranchIcon_L : HierarchyDesigner_Shared_Resources.TreeBranchIcon_TerminalBud;
            }
            else
            {
                icon = HierarchyDesigner_Shared_Resources.TreeBranchIcon_T;
            }
            return icon;
        }
