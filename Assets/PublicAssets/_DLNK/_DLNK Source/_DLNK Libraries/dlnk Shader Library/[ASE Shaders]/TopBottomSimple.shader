	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 unpack4 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), (0.0 + (_BumpScale - 0.0) * (0.99 - 0.0) / (1.0 - 0.0)) );
				unpack4.z = lerp( 1, unpack4.z, saturate((0.0 + (_BumpScale - 0.0) * (0.99 - 0.0) / (1.0 - 0.0))) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 lerpResult44 = lerp( ( _Color * tex2DNode2 ) , ( tex2DNode2 * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) * _Color ) , tex2DNode43.a);
				float2 temp_cast_0 = (_TopTiling).xx;
				float2 texCoord110 = packedInput.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
...
Node;AmplifyShaderEditor.SamplerNode;3;-712.8995,-182.3;Inherit;True;Property;_AlbedoTop;AlbedoTop;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;7;-666.1178,732.2252;Inherit;True;Property;_MetalnessTop;MetalnessTop;23;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;137;1;11;0
WireConnection;137;4;14;0
WireConnection;137;7;19;0
WireConnection;137;8;54;0
WireConnection;35;5;38;0
WireConnection;149;0;12;0
ASEEND*/
//CHKSM=059DA26CFA52F514A1D9054436C39B1EB87DDE9B