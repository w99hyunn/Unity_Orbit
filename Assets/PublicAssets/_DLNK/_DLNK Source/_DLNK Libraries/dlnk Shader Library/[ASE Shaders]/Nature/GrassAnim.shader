	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth141 = inputMesh.positionOS;
				float customEye141 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth141)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord5.z = customEye141;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = customEye161;
						...
						)
			{
				...
				float2 texCoord104 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_0;
				...
				float customEye141 = packedInput.ase_texcoord5.z;
				...
				float customEye161 = packedInput.ase_texcoord5.w;
				...
				surfaceDescription.BaseColor = lerpResult153.rgb;
				...
				surfaceDescription.Occlusion = ( pow( texCoord104.y , _Occlusion ) + temp_output_167_0 );
				surfaceDescription.Alpha = saturate( ( tex2DNode7.a * ( 1.0 - ( ( temp_cast_2 * temp_output_2_0_g9 ) + appendResult7_g9 ) ) ) ).x;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 customSurfaceDepth141 = inputMesh.positionOS;
				float customEye141 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth141)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord2.z = customEye141;
				
				float3 customSurfaceDepth161 = inputMesh.positionOS;
				float customEye161 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth161)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = customEye161;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_ColorOffset).xx;
				float2 texCoord104 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
				float4 lerpResult49 = lerp( _ColorA , _ColorB , saturate( pow( texCoord104.y , _ColorRange ) ));
				float2 uv_MainTex = packedInput.ase_texcoord2.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode7 = tex2D( _MainTex, uv_MainTex );
				float4 lerpResult108 = lerp( lerpResult49 , ( tex2DNode7 * lerpResult49 ) , pow( texCoord104.y , _TextureOverride ));
				float customEye141 = packedInput.ase_texcoord2.z;
				float cameraDepthFade141 = (( customEye141 -_ProjectionParams.y - _DepthOffset ) / _Depth);
				float temp_output_167_0 = saturate( ( saturate( cameraDepthFade141 ) * _FarFresnel ) );
				float4 lerpResult152 = lerp( saturate( lerpResult108 ) , _ColorFar , temp_output_167_0);
				float4 lerpResult153 = lerp( saturate( lerpResult152 ) , lerpResult108 , _BlendOriginal);
				...
				float customEye161 = packedInput.ase_texcoord2.w;
				float cameraDepthFade161 = (( customEye161 -_ProjectionParams.y - _DepthOffset ) / _DepthCutout);
				float3 temp_cast_2 = (cameraDepthFade161).xxx;
				float temp_output_2_0_g9 = tex2DNode7.a;
				float temp_output_3_0_g9 = ( 1.0 - temp_output_2_0_g9 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 customSurfaceDepth161 = inputMesh.positionOS;
				float customEye161 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth161)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord1.z = customEye161;
					...
					)
			{
				...
				float4 tex2DNode7 = tex2D( _MainTex, uv_MainTex );
				float customEye161 = packedInput.ase_texcoord1.z;
				float cameraDepthFade161 = (( customEye161 -_ProjectionParams.y - _DepthOffset ) / _DepthCutout);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 customSurfaceDepth141 = inputMesh.positionOS;
				float customEye141 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth141)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord7.z = customEye141;
				
				float3 customSurfaceDepth161 = inputMesh.positionOS;
				float customEye161 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth161)).z;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = customEye161;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_ColorOffset).xx;
				float2 texCoord104 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + temp_cast_0;
				float4 lerpResult49 = lerp( _ColorA , _ColorB , saturate( pow( texCoord104.y , _ColorRange ) ));
				float2 uv_MainTex = packedInput.ase_texcoord7.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode7 = tex2D( _MainTex, uv_MainTex );
				float4 lerpResult108 = lerp( lerpResult49 , ( tex2DNode7 * lerpResult49 ) , pow( texCoord104.y , _TextureOverride ));
				float customEye141 = packedInput.ase_texcoord7.z;
				float cameraDepthFade141 = (( customEye141 -_ProjectionParams.y - _DepthOffset ) / _Depth);
				float temp_output_167_0 = saturate( ( saturate( cameraDepthFade141 ) * _FarFresnel ) );
				float4 lerpResult152 = lerp( saturate( lerpResult108 ) , _ColorFar , temp_output_167_0);
				float4 lerpResult153 = lerp( saturate( lerpResult152 ) , lerpResult108 , _BlendOriginal);
				...
				float customEye161 = packedInput.ase_texcoord7.w;
				float cameraDepthFade161 = (( customEye161 -_ProjectionParams.y - _DepthOffset ) / _DepthCutout);
				float3 temp_cast_2 = (cameraDepthFade161).xxx;
				float temp_output_2_0_g9 = tex2DNode7.a;
				float temp_output_3_0_g9 = ( 1.0 - temp_output_2_0_g9 );
		...
		Pass
        {
					...
					)
			{
				...
				float2 uv_MainTex = packedInput.ase_texcoord2.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode7 = tex2D( _MainTex, uv_MainTex );
				float customEye161 = packedInput.ase_texcoord2.z;
				float cameraDepthFade161 = (( customEye161 -_ProjectionParams.y - _DepthOffset ) / _DepthCutout);
				float3 temp_cast_0 = (cameraDepthFade161).xxx;
				float temp_output_2_0_g9 = tex2DNode7.a;
				float temp_output_3_0_g9 = ( 1.0 - temp_output_2_0_g9 );
...
WireConnection;197;0;153;0
WireConnection;197;1;11;0
WireConnection;197;7;55;0
WireConnection;197;8;168;0
