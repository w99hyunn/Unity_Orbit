...
Shader "DLNK Shaders/ASE/Nature/WaterRunning"
{
	Properties
	{
		...
		_RefractionLevel("Refraction Level", Float) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Metallic = saturate( ( (lerpResult39).a * _Metalness ) );
				...
				#ifdef _HAS_REFRACTION
				surfaceDescription.RefractionIndex = _RefractionLevel;
...
WireConnection;57;4;52;0
WireConnection;57;7;45;0
WireConnection;57;9;40;0
WireConnection;57;17;41;0
WireConnection;57;11;53;0
ASEEND*/
//CHKSM=799CA76DAF7B2E99154FC497B28BBE6FAC69508C