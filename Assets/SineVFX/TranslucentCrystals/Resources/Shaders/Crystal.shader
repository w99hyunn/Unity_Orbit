...
Shader "SineVFX/TranslucentCrystals/Crystal"
{
	Properties
	{
		...
		[ASEDiffusionProfile(_DP)]_DP_asset("DP", Vector) = ( 0, 0, 0, 0 )
		[HideInInspector]_DP("DP", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlbedoMask = packedInput.ase_texcoord5.xy * _AlbedoMask_ST.xy + _AlbedoMask_ST.zw;
				...
				float2 uv_RampMask = packedInput.ase_texcoord5.xy * _RampMask_ST.xy + _RampMask_ST.zw;
				...
				float2 uv_TranslucencyMask = packedInput.ase_texcoord5.xy * _TranslucencyMask_ST.xy + _TranslucencyMask_ST.zw;
				
				surfaceDescription.Albedo = lerpResult17.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMask = packedInput.ase_texcoord.xy * _AlbedoMask_ST.xy + _AlbedoMask_ST.zw;
				float4 lerpResult17 = lerp( _ColorTint1 , _ColorTint2 , tex2D( _AlbedoMask, uv_AlbedoMask ).r);
				...
				float4 tex2DNode5 = tex2D( _Emission, uv_Emission );
				float2 uv_RampMask = packedInput.ase_texcoord.xy * _RampMask_ST.xy + _RampMask_ST.zw;
				float4 tex2DNode22 = tex2D( _RampMask, uv_RampMask );
				#ifdef _RAMPINVERTED_ON
				float staticSwitch26 = ( 1.0 - tex2DNode22.r );
				#else
				...
				float2 uv_MetallicSmoothness = packedInput.ase_texcoord.xy * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				
				float2 uv_TranslucencyMask = packedInput.ase_texcoord.xy * _TranslucencyMask_ST.xy + _TranslucencyMask_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMask = packedInput.ase_texcoord7.xy * _AlbedoMask_ST.xy + _AlbedoMask_ST.zw;
				float4 lerpResult17 = lerp( _ColorTint1 , _ColorTint2 , tex2D( _AlbedoMask, uv_AlbedoMask ).r);
				...
				float4 tex2DNode5 = tex2D( _Emission, uv_Emission );
				float2 uv_RampMask = packedInput.ase_texcoord7.xy * _RampMask_ST.xy + _RampMask_ST.zw;
				float4 tex2DNode22 = tex2D( _RampMask, uv_RampMask );
				#ifdef _RAMPINVERTED_ON
				float staticSwitch26 = ( 1.0 - tex2DNode22.r );
				#else
				...
				float2 uv_TranslucencyMask = packedInput.ase_texcoord7.xy * _TranslucencyMask_ST.xy + _TranslucencyMask_ST.zw;
...
/*ASEBEGIN
Version=18301
1920;0;1920;1019;1373.886;448.0675;1.666522;True;False
Node;AmplifyShaderEditor.SamplerNode;22;-2179.814,-214.3205;Inherit;True;Property;_RampMask;Ramp Mask;20;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;27;-1799.809,-273.402;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;26;-1541.809,-220.402;Float;False;Property;_RampInverted;Ramp Inverted;18;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;39;-880.6624,131.2767;Inherit;False;Property;_EmissionColor2;Emission Color2;15;0;Create;True;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;21;-990.6935,-243.1058;Inherit;True;Property;_Ramp;Ramp;19;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;8;-946.7004,304.3475;Float;False;Property;_EmissionPower;Emission Power;14;0;Create;True;0;0;False;0;False;2;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-353.4277,428.8817;Float;False;Property;_TranslucencyMaskPower;Translucency Mask Power;8;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-370.1785,226.3078;Inherit;True;Property;_TranslucencyMask;Translucency Mask;7;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-506.0231,881.6746;Float;False;Property;_Smoothness;Smoothness;23;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;12;-609.6003,599.6158;Inherit;True;Property;_MetallicSmoothness;MetallicSmoothness;21;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DiffusionProfileNode;40;198.3114,673.7811;Float;False;Property;_DP;DP;17;0;Create;True;0;0;False;0;False;0;0;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-505.0231,797.6746;Float;False;Property;_Metallic;Metallic;22;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
WireConnection;28;21;40;0
ASEEND*/
//CHKSM=924D1D8051C648D18488B52F5F5E3390E8FE5440